...
<a href='cetak_lap_pembelian_rekap.php' id="cetak_lap" class='btn btn-success' target='blank' style="display: none"><i class='fa fa-print'> </i> Cetak Pembelian </a>
...
//PICKERDATE
	$(function(){
    $( ".tanggal_cari" ).datepicker({dateFormat: "yy-mm-dd"});
	});
	// /PICKERDATE
</script>
