...
$(document).on('click', '#submit_produk', function (e) {
  ...
  var hitung_potongan = parseInt(subtotal,10) - parseInt(potongan,10);
  ...
  if (a > 0){
    ...
    var pesan_alert = confirm("Harga Produk '"+nama_barang+"' Bernilai 0. Anda Yakin Ingin Melanjutkan ?");
      ...
      if (pesan_alert == true){
          ...
          $.post("proses_tbs_orderpenjualan.php",{no_faktur:no_faktur,kode_barang:kode_barang,nama_barang:nama_barang,jumlah_barang:jumlah_barang,harga_konversi:harga_konversi,harga_produk:harga_produk,potongan:potongan,tax:tax,satuan:satuan,sales:sales,ppn:ppn},function(data){
           ...
           $("#level_harga").val(level_harga);
                            ...
                            <script type="text/javascript">
                                 ...
                                 $(document).on('blur','.input_jumlah',function(e){
                                    ...
                                    $.getJSON("cek_setting_diskon_jumlah.php?jumlah_barang="+jumlah_baru+"&kode_barang="+kode_barang+"&id_produk="+id_produk+"&satuan_konversi="+satuan_konversi, function(data){                                  
                              ...
                              if (ber_stok == 'Jasa'){
                                    ...
                                    $("#text-potongan-"+id+"").text(tandaPemisahTitik(potongan));
