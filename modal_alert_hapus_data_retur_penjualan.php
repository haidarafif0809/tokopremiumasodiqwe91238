...
include 'db.php';
 ...
 $hpp_keluar = $db->query("SELECT no_faktur, tanggal, jenis_transaksi FROM hpp_keluar WHERE no_faktur_hpp_masuk = '$no_faktur'");
 ?>
...
<table id="tableuser" class="table table-hover">
    ...
    <tbody>
          ...
          while ($data2 = mysqli_fetch_array($hpp_keluar))
          {
          //menampilkan data
          echo "<tr>
