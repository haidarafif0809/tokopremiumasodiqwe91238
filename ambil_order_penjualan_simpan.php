...
$no_fakt = stringdoang($_POST['no_faktur']);
...
$update_status_order = $db->query("UPDATE tbs_fee_produk SET no_faktur = '$no_fakt' WHERE no_faktur_order = '$no_faktur' ");
