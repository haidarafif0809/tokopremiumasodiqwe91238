...
<div class="table-responsive">
 <table id="tableuser" class="table table-bordered">
					...
					//menampilkan data
						...
						$perintah21 = $db->query("SELECT SUM(nilai_kredit) AS t_kredit FROM pembelian WHERE tanggal = '$data[tanggal]'");
...
<br>
       ...
       <a href='cetak_lap_pembelian_harian.php?dari_tanggal=<?php echo $dari_tanggal; ?>&sampai_tanggal=<?php echo $sampai_tanggal; ?>' class='btn btn-success'><i class='fa fa-print'> </i> Cetak Pembelian </a>
