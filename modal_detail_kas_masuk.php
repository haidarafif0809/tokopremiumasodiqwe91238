...
$sql.=" FROM detail_kas_masuk km INNER JOIN daftar_akun da ON km.ke_akun = da.kode_daftar_akun";
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
  ...
  $perintah1 = $db->query("SELECT km.id, km.no_faktur, km.keterangan, km.dari_akun, km.jumlah, km.tanggal, km.jam, km.user, da.nama_daftar_akun FROM detail_kas_masuk km INNER JOIN daftar_akun da ON km.dari_akun = da.kode_daftar_akun WHERE km.dari_akun = '$row[dari_akun]'");
