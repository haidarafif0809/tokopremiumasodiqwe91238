...
include 'db.php';
 ...
 $hpp_keluar_penjualan = $db->query("SELECT no_faktur, tanggal, kode_barang, jenis_transaksi FROM hpp_keluar WHERE no_faktur_hpp_masuk = '$no_faktur' AND kode_barang = '$kode_barang'");
...
<table id="tableuser" class="table table-hover">
    ...
    <tbody>
          ...
          while ($data1 = mysqli_fetch_array($hpp_keluar_penjualan))
          {
          //menampilkan data
          echo "<tr>
