...
$query00 = $db->query("SELECT SUM(jumlah) AS jumlah_produk FROM kartu_stok WHERE kode_barang = '$kode_barang' AND tipe = 'Pembelian' AND tanggal < '$dari_tanggal'  ");
$cek0 = mysqli_fetch_array($query00);
 $jumlah_produk0 = $cek0['jumlah_produk'];

$query10 = $db->query("SELECT SUM(jumlah) AS jumlah_retur FROM kartu_stok WHERE kode_barang = '$kode_barang' AND tipe = 'Retur Penjualan' AND tanggal < '$dari_tanggal' ");
$cek10 = mysqli_fetch_array($query10);
 $jumlah_retur0 = $cek10['jumlah_retur'];


$query20 = $db->query("SELECT SUM(jumlah) AS jumlah_item FROM kartu_stok WHERE kode_barang = '$kode_barang' AND tipe = 'Stok Awal' AND tanggal < '$dari_tanggal' ");
$cek20 = mysqli_fetch_array($query20);
 $jumlah_item0 = $cek20['jumlah_item'];

$query30 = $db->query("SELECT SUM(jumlah) AS jumlah_stok_awal FROM kartu_stok WHERE kode_barang = '$kode_barang' AND tipe = 'Item Masuk' AND tanggal < '$dari_tanggal' ");
...
$querdo0 = $db->query("SELECT SUM(jumlah) AS jumlah_produk_jual FROM kartu_stok WHERE kode_barang = '$kode_barang' AND tipe = 'Penjualan' AND tanggal < '$dari_tanggal' ");
$out0 = mysqli_fetch_array($querdo0);
$jumlah_jual0 = $out0['jumlah_produk_jual'];

$querdo10 = $db->query("SELECT SUM(jumlah) AS jumlah_produk_retur FROM kartu_stok WHERE kode_barang = '$kode_barang' AND tipe = 'Retur Pembelian' AND tanggal < '$dari_tanggal' ");
$out10 = mysqli_fetch_array($querdo10);
$jumlah_produk_retur_beli0 = $out10['jumlah_produk_retur'];

$querdo20 = $db->query("SELECT SUM(jumlah) AS jumlah_item_keluar FROM kartu_stok WHERE kode_barang = '$kode_barang' AND tipe = 'Item Keluar' AND tanggal < '$dari_tanggal' ");
...
$select_to = $db->query("SELECT * FROM kartu_stok WHERE kode_barang = '$kode_barang' AND tanggal >= '$dari_tanggal' AND tanggal <= '$sampai_tanggal' ORDER BY tanggal ASC");
