...
<form class="form" role="form" id="formparceledit">
		...
		<div class="col-sm-6">	
		    ...
		    <input style="height:15px;" type="text" class="form-control" name="nama_parcel" autocomplete="off" id="nama_parcel_edit" placeholder="NAMA PARCEL">
		  	...
		  	<label>Harga 1</label>
		    <input style="height:15px;" type="text" class="form-control" name="harga_parcel_1" autocomplete="off" id="harga_parcel_edit_1" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" placeholder="HARGA 1">

		  
		  	<label>Harga 2</label>
		    <input style="height:15px;" type="text" class="form-control" name="harga_parcel_2" autocomplete="off" id="harga_parcel_edit_2" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" placeholder="HARGA 2">

		  
		  	<label>Harga 3</label>
		    <input style="height:15px;" type="text" class="form-control" name="harga_parcel_3" autocomplete="off" id="harga_parcel_edit_3" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" placeholder="HARGA 3">
		...
		<div class="col-sm-6">
		  	...
		  	<label>Harga 4</label>
		    <input style="height:15px;" type="text" class="form-control" name="harga_parcel_4" autocomplete="off" id="harga_parcel_edit_4" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" placeholder="HARGA 4">

		  
		  	<label>Harga 5</label>
		    <input style="height:15px;" type="text" class="form-control" name="harga_parcel_5" autocomplete="off" id="harga_parcel_edit_5" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" placeholder="HARGA 5">

		  
		  	<label>Harga 6</label>
		    <input style="height:15px;" type="text" class="form-control" name="harga_parcel_6" autocomplete="off" id="harga_parcel_edit_6" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" placeholder="HARGA 6">

		  
		  	<label>Harga 7</label>
		    <input style="height:15px;" type="text" class="form-control" name="harga_parcel_7" autocomplete="off" id="harga_parcel_edit_7" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" placeholder="HARGA 7">


		  <input style="height:15px;" type="hidden" class="form-control" name="id_edit" autocomplete="off" id="id_edit" placeholder="HARGA 7">
...
<div class="collapse" id="collapseExample">
	...
	<form class="form" role="form" id="formparcel">
		...
		<div class="row">
		  ...
		  <div class="col-sm-2">
		  	<label>Harga 1</label>
		    <input style="height:15px;" type="text" class="form-control" name="harga_parcel_1" autocomplete="off" id="harga_parcel_1" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" placeholder="HARGA 1">
		  </div>

		  <div class="col-sm-2">
		  	<label>Harga 2</label>
		    <input style="height:15px;" type="text" class="form-control" name="harga_parcel_2" autocomplete="off" id="harga_parcel_2" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" placeholder="HARGA 2">
		  </div>

		  <div class="col-sm-2">
		  	<label>Harga 3</label>
		    <input style="height:15px;" type="text" class="form-control" name="harga_parcel_3" autocomplete="off" id="harga_parcel_3" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" placeholder="HARGA 3">
		  </div>
		...
		<div class="row">
		  ...
		  <div class="col-sm-2">
		  	<label>Harga 4</label>
		    <input style="height:15px;" type="text" class="form-control" name="harga_parcel_4" autocomplete="off" id="harga_parcel_4" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" placeholder="HARGA 4">
		  </div>

		  <div class="col-sm-2">
		  	<label>Harga 5</label>
		    <input style="height:15px;" type="text" class="form-control" name="harga_parcel_5" autocomplete="off" id="harga_parcel_5" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" placeholder="HARGA 5">
		  </div>

		  <div class="col-sm-2">
		  	<label>Harga 6</label>
		    <input style="height:15px;" type="text" class="form-control" name="harga_parcel_6" autocomplete="off" id="harga_parcel_6" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" placeholder="HARGA 6">
		  </div>

		  <div class="col-sm-2">
		  	<label>Harga 7</label>
		    <input style="height:15px;" type="text" class="form-control" name="harga_parcel_7" autocomplete="off" id="harga_parcel_7" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" placeholder="HARGA 7">
		  </div>
...
$(document).on('click', '.btn-hapus-parcel', function (e) {
  ...
  var table = $('#tabel_parcel').DataTable(); 
