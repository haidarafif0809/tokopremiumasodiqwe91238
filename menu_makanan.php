<?php include 'session_login.php';
    ...
    $perintah = $db->query("SELECT * FROM barang WHERE kategori = 'Makanan' ORDER BY id DESC");
...
<ul class="nav nav-tabs">
  ...
  <li class="active"><a href="menu_makan.php">Menu Makanan</a></li>
  <li><a href="menu_minuman.php">Menu Minuman</a></li>
  <li ><a href="menu_beef.php">Menu Beef</a></li>
...
<button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-plus"> </span> Tambah Item
</button> <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#my_Modal"><span class="glyphicon glyphicon-import"> </span> Import Data Excell
</button>
<br>
<br>
