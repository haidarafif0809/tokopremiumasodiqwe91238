<?php session_start(); 
    ...
    $waktu = date('Y-m-d H:i:s');
            ...
            $perintah = $db->prepare("INSERT INTO tbs_tukar_poin(no_faktur, kode_barang, nama_barang, satuan, jumlah_barang, poin, subtotal_poin, tanggal, jam, waktu,pelanggan) VALUES (?,?,?,?,?,?,?,?,?,?,?)");
            
            
            $perintah->bind_param("sssiiiisssi",
            $no_faktur, $kode_barang, $nama_barang, $satuan, $jumlah_barang, $poin, $subtotal, $tanggal_sekarang, $jam_sekarang,$waktu,$pelanggan);
