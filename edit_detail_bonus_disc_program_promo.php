<?php
    ...
    $query = $db->prepare("UPDATE promo_disc_produk SET nama_program = ?, qty_max = ?, harga_disc = ?,  nama_produk= ? ,satuan = ? WHERE id = ?");
    
    $query->bind_param("iiiiii",
        $nama_program, $qty_max, $harga_disc, $nama_produk,$satuan, $id);
