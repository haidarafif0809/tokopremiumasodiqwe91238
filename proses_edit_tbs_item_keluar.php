<?php 
    ...
    $cek = $db->query("SELECT * FROM tbs_item_keluar WHERE kode_barang = '$kode_barang' AND no_faktur = '$no_faktur'");
    ...
    {
        $perintah = $db->prepare("INSERT INTO tbs_item_keluar (no_faktur,kode_barang,nama_barang,jumlah,satuan,harga,subtotal) VALUES (?,?,?,?,?,?,?)");
