...
<script type="text/javascript">
		$(document).on('click','#submit',function(e){
			$('#table_lap_pembelian_harian').DataTable().destroy();
            ...
            $('#table_tampil').show();
			$('#result').hide();
          var dataTable = $('#table_lap_pembelian_harian').DataTable( {
          "processing": true,
          "serverSide": true,
          "ajax":{
            ...
            error: function(){  // error handling
              ...
              $("#table_lap_pembelian_harian").append('<tbody class="employee-grid-error"><tr><th colspan="3">No data found in the server</th></tr></tbody>');
