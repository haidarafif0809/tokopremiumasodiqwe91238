...
$(document).on('click', '.pilih', function (e) {
  ...
  $.post('cek_tbs_parcel.php',{id_produk:id_produk, session_id:session_id}, function(data){
...
if (nama_parcel == "") {
  ...
  else
  {
    ...
    $.getJSON('lihat_sisa_produk_parcel.php',{session_id:session_id ,kode_barang:kode_barang, jumlah_parcel:jumlah_parcel, jumlah_barang:jumlah_barang, id_produk:id_produk}, function(json){
      ...
      if (jumlah_produk < 0) {
            ...
            $.post("proses_isi_parcel.php",{id_produk:id_produk,jumlah_barang:jumlah_barang,session_id:session_id},function(data) {
...
if (nama_parcel == "") {
  ...
  else
  {
            ...
            $.post("proses_simpan_parcel.php",{id_produk:id_produk,jumlah_barang:jumlah_barang,session_id:session_id,
  ...
  else
  {
    ...
    $.getJSON('cek_stok_produk_parcel.php',{jumlah_parcel:jumlah_parcel,kode_barang:kode_barang, jumlah_baru:jumlah_baru, id_produk:id_produk, jumlah_lama:jumlah_lama}, function(json){
      ...
      if (jumlah_produk < 0) {
          ...
          $.post("update_jumlah_produk_parcel.php",{jumlah_lama:jumlah_lama,id_produk:id_produk,jumlah_baru:jumlah_baru, session_id:session_id},function(){
...
$(document).ready(function(){
  $("#batal_produk").click(function(){
    ...
    if (pesan_alert == true) {
        ...
        $.get("batal_perakitan_parcel.php",{session_id:session_id},function(data){
