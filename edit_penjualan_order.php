...
<div class="row">
  ...
  <input type="hidden" class="form-control" name="limit_stok" autocomplete="off" id="limit_stok" placeholder="Limit Stok" >
    ...
    <input type="hidden" id="harga_konversi" name="harga_konversi">
...
$.post("barcode_edit_order.php",{kode_barang:kode_barang,sales:sales,level_harga:level_harga,no_faktur:no_faktur},function(data){
  ...
  alert("Kode Pelanggan Harus Dipilih");
     ...
     $.post("proses_edit_tbs_orderpenjualan.php",{ber_stok:ber_stok,no_faktur:no_faktur,kode_barang:kode_barang,nama_barang:nama_barang,jumlah_barang:jumlah_barang,harga_konversi:harga_konversi,harga_produk:harga_produk,potongan:potongan,tax:tax,satuan:satuan,sales:sales},function(data){
...
$(document).on('click','.btn-hapus-tbs',function(e){
      ...
      var no_faktur_order = $("#no_faktur_order").val();
        ...
        $.post("hapustbs_penjualanorder.php",{no_faktur_order:no_faktur_order,id:id,kode_barang:kode_barang},function(data){
                                    ...
                                    $.post("cek_stok_pesanan_barang.php",{kode_barang:kode_barang, jumlah_baru:jumlah_baru,satuan_konversi:satuan_konversi},function(data){
                                       ...
                                       if (data < 0) {
                                           ...
                                           alert("Jumlah Yang Di Masukan Melebihi Stok !");
                                            ...
                                            $.post("update_pesanan_barang_order.php",{no_faktur:no_faktur,jumlah_lama:jumlah_lama,tax:tax,id:id,jumlah_baru:jumlah_baru,kode_barang:kode_barang,potongan:potongan,harga:harga,jumlah_tax:jumlah_tax,subtotal:subtotal},function(info){
                                            var tabel_tbs_editorder = $('#tabel_tbs_editorder').DataTable();
                                            tabel_tbs_editorder.draw();

                                            $("#total2").val(tandaPemisahTitik(info)); 
                                        });
