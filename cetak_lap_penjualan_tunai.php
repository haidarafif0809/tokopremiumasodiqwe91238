...
$no_faktur = $_GET['no_faktur'];
 ...
 <table>
  ...
  <tbody>
           ...
           echo '<tr><td width:"50%"> '. $data2['nama_barang'] .' </td> <td style="padding:3px"> '. koma($data2['jumlah_barang'],2) .'</td>  <td style="padding:3px"> '. rp($data2['harga']) .'</td>  <td style="padding:3px"> '. rp($data2['subtotal']) . ' </td></tr>';
