...
<a href='cetak_pemasukan_pertanggal.php?tanggal=<?php echo $tanggal; ?>&dari_akun=<?php echo $dari_akun ?>' class='btn btn-success' target='blank'><span class='glyphicon glyphicon-print'> </span> Cetak  </a>
</div>
