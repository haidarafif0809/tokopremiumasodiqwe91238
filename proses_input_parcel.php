...
include 'sanitasi.php';
	...
	$nama_petugas = $_SESSION['nama'];
		...
		$insert_perakitan_parcel = "INSERT INTO perakitan_parcel (kode_parcel, nama_parcel, harga_parcel, harga_parcel_2, harga_parcel_3, harga_parcel_4, harga_parcel_5, harga_parcel_6, harga_parcel_7, user_input) 
		VALUES ('$kode_parcel', '$nama_parcel', '$harga_parcel_1', '$harga_parcel_2', '$harga_parcel_3', '$harga_parcel_4', '$harga_parcel_5', '$harga_parcel_6', '$harga_parcel_7', '$nama_petugas')";
