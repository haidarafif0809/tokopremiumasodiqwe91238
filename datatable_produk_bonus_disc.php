...
$sql = "SELECT b.id,b.nama_barang,b.satuan as satuan_barang, b.harga_jual,b.kode_barang,pp.nama_produk,pp.nama_program,pp.satuan,pp.id,pp.harga_disc,pp.qty_max,p.nama_program as program ";
...
$sql = "SELECT b.id,b.nama_barang,b.satuan as satuan_barang,b.kode_barang,pp.nama_produk,pp.nama_program,pp.satuan,pp.id,p.nama_program as program";
...
$sql.=" ORDER BY pp.id LIMIT ".$requestData['start']." ,".$requestData['length']."   ";
