<?php session_start();
    ...
    $perubahan_harga = 0;
 	...
 	$query = $db->query("SELECT harga,kode_barang,jumlah_barang,satuan FROM tbs_pembelian WHERE session_id = '$session_id' AND kode_barang = '$kode_barang' AND no_faktur IS NULL");
