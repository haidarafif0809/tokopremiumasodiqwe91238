...
include 'db.php';
 ...
 $hpp_masuk_stok_opname = $db->query("SELECT no_faktur, tanggal, jenis_transaksi FROM hpp_keluar WHERE no_faktur_hpp_masuk = '$no_faktur' AND kode_barang = '$kode_barang' ");
