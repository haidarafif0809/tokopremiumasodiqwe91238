...
if ($lihat['order_pembelian_lihat'] > 0){

echo '<li><a href="form_order_pembelian.php" class="waves-effect"> <i class="fa fa-shopping-basket"></i>Order Pembelian </a></li>';
...
if ($lihat['akuntansi_lihat'] > 0){       
 ...
 if ($lihat['laporan_komisi_produk_lihat'] > 0){
                            ...
                            echo '<li><a href="order_pembelian.php" class="waves-effect">Lap. Order Pembelian</a></li>';
