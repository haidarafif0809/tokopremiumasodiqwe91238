...
include 'sanitasi.php';
 ...
 $hpp_masuk_penjualan = $db->query("SELECT no_faktur, tanggal, kode_barang, jenis_transaksi FROM hpp_keluar WHERE no_faktur_hpp_masuk = '$no_faktur' AND kode_barang = '$kode_barang' ");
