...
$query1 = $db->query("SELECT * FROM retur_pembelian ORDER BY id DESC LIMIT 1");
 ...
 */
 if ($v_bulan_terakhir['bulan'] != $v_bulan['bulan']) {
  # code...
echo $no_faktur = "1/RB/".$data_bulan_terakhir."/".$tahun_terakhir;
...
echo $no_faktur = $nomor."/RB/".$data_bulan_terakhir."/".$tahun_terakhir;
