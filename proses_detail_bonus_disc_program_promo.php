...
$insert_produk = $db->prepare("INSERT INTO promo_disc_produk (nama_program,nama_produk,qty_max,harga_disc,satuan) VALUES (?,?,?,?,?)");
  
// hubungkan "data" dengan prepared statements
$insert_produk->bind_param("iiiii",
$id_program,$id_produk,$qty,$harga_disc,$satuan);
