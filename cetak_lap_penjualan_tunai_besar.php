...
<div class="container">
 ...
 <table>
  <tbody>
      ...
      <tr><td  width="25%"><font class="satu">Nama</font></td> <td> :&nbsp;</td> <td><font class="satu"> <?php echo $data0['nama_pelanggan']; ?> </font></td></tr>
...
div.mix {border-style: dotted dashed solid double;}
 ...
 <table>
  <tbody>
      ...
      <tr><td  width="50%"><font class="satu">Biaya Admin</font></td> <td> :&nbsp;</td> <td><font class="satu"> <?php echo koma($data0['biaya_admin'],2); ?> </font></td></tr>
      <!--<tr><td  width="50%"><font class="satu">Tax</font></td> <td> :&nbsp;</td> <td><font class="satu"> <?php echo koma($data0['tax']); ?> </font></td></tr>-->
 ...
 <table>
  <tbody>
      ...
      <tr><td  width="40%"><font class="satu">Kembali</font></td> <td> :&nbsp;</td> <td><font class="satu"> <?php echo koma($data0['sisa'],2); ?></font> </td></tr>
