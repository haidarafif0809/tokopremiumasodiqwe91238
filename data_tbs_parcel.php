...
$id_parcel = stringdoang($_POST['id_parcel']);
...
$sql =" SELECT tp.id, tp.id_parcel, tp.id_produk, tp.jumlah_produk, b.kode_barang, b.nama_barang, b.satuan, s.nama";
$sql.=" FROM detail_perakitan_parcel tp INNER JOIN barang b ON tp.id_produk = b.id INNER JOIN satuan s ON b.satuan = s.id";
$sql.=" WHERE tp.id_parcel = '$id_parcel'";
