...
<a href="pembelian.php">
        <li class="tile tile-big tile-10 slideTextUp" data-page-type="s-page" data-page-name="custom-page">
          <div><p style="font-size: 45px"><img src="images/shopping-cart-2.png" style="width:100px; height:100px" />Pembelian</p></div>
          <div><p style="font-size: 45px"><img src="images/shopping-cart-2.png" style="width:100px; height:100px" />Pembelian</p></div>
...
<a href="retur_pembelian.php">
          <li class="tile tile-big tile-5" data-page-type="r-page" data-page-name="random-r-page">
            <div class="front"><p style="font-size: 35px"><img src="images/shopping.png" style="width:100px; height:100px" />Retur Pembelian</p></div>
        </li>
</a>


<a href="pembayaran_hutang.php">
        <li class="tile tile-big tile tile-1 slideTextRight" data-page-type="s-page" data-page-name ="random-restored-page">
          <div><p  style="font-size: 25px"><img src="images/money-68.png" style="width:100px; height:100px" />Pembayaran Hutang</p></div>
