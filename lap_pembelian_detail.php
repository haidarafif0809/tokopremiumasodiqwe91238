...
<div class="table-responsive">
					<table id="table_lap_pembelian_detail" class="table table-bordered">
					<thead>
					<th style="background-color: #4CAF50; color: white;"> Nomor Faktur </th>
					<th style="background-color: #4CAF50; color: white;"> Kode Barang </th>
					<th style="background-color: #4CAF50; color: white;"> Nama Barang </th>
...
<br>
 ...
 <table>
  <tbody>
      <tr><td style="font-size: 30px" width="50%">Total</td> <td style="font-size: 30px"> :&nbsp; </td> <td style="font-size: 30px"><span id="totalane"></span></td>
      </tr>
  </tbody>
  </table>
  <br><br>
...
<script type="text/javascript">
        ...
        $.post("cek_total_detail.php",{dari_tanggal:dari_tanggal,sampai_tanggal:sampai_tanggal},function(data){
