...
$sql.=" (SELECT SUM(total_nilai) AS total_hpp FROM hpp_keluar WHERE kode_barang = detail_penjualan.kode_barang AND hpp_keluar.tanggal >= '$dari_tgl' AND hpp_keluar.tanggal <= '$sampai_tgl' ) AS total_hpp, ";//total hpp
$sql.=" SUM(subtotal) - (SELECT SUM(total_nilai) AS total_hpp FROM hpp_keluar WHERE kode_barang = detail_penjualan.kode_barang AND hpp_keluar.tanggal >= '$dari_tgl' AND hpp_keluar.tanggal <= '$sampai_tgl' ) AS total_laba ";// total laba
