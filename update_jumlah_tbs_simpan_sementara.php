...
$query->execute();
    ...
    $query9 = $db->query("SELECT * FROM fee_produk WHERE nama_petugas = '$petugas_sales' AND kode_produk = '$kode'");
    ...
    $nominal = $cek9['jumlah_uang'];
        ...
        if ($prosentase != 0)
            ...
            $query1 = $db->query("UPDATE tbs_fee_produk SET jumlah_fee = '$fee_prosentase_produk' WHERE nama_petugas = '$petugas_sales' AND kode_produk = '$kode' AND no_faktur = '$nomor'");
   ...
   elseif ($nominal != 0) 
            ...
            $query01 = $db->query("UPDATE tbs_fee_produk SET jumlah_fee = '$fee_nominal_produk' WHERE nama_petugas = '$petugas_sales' AND kode_produk = '$kode' AND no_faktur = '$nomor'");
