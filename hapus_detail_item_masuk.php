...
$no_faktur = $_GET['no_faktur'];
        ...
        $query3 = $db->query("SELECT * FROM detail_item_masuk WHERE no_faktur = '$no_faktur'");
    ...
    echo "Error: " . $query1 . "<br>" . $db->error;
        ...
        $query = $db->query("DELETE FROM detail_item_masuk WHERE no_faktur = '$no_faktur'");
...
header('location:detail_item_masuk.php');
}
else
{
    echo "failed";
